...
class HomeViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationController?.hidesBarsOnSwipe = true // 스크롤시 네비게이션 바 숨기기
       ...
       contents = getContents()
        ...
        collectionView.register(ContentCollectionViewRank.self, forCellWithReuseIdentifier: "ContentCollectionViewRank")
    ...
    //각각의 섹션타입에 대한 UICollectionViewLayout 생성
...
extension HomeViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .basic, .large:
            ...
            return cell
        case .rank:
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "ContentCollectionViewRank", for: indexPath) as? ContentCollectionViewRank else {return UICollectionViewCell()}
            cell.imageView.image = contents[indexPath.section].contentItem[indexPath.row].image
