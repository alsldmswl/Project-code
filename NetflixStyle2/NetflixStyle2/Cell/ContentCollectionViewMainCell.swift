...
class ContentCollectionViewMainCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        //baseStackView 안에 커포넌트들
        [imageView, descriptionLabel, contentStackView].forEach{
            baseStackView.addArrangedSubview($0) //stackView에 넣을때
        }
    ...
    @objc func tvButtonTapped(sender: UIButton!) {
        print("TEST: tvButtonTapped")
    }
    @objc func movieButtonTapped(sender: UIButton!) {
        print("TEST: movieButtonTapped")
    }
    @objc func categoryButtonTapped(sender: UIButton!) {
        print("TEST: categoryButtonTapped")
    }
    @objc func plusButtonTapped(sender: UIButton!) {
        print("TEST: plusButtonTapped")
    }
    @objc func infoButtonTapped(sender: UIButton!) {
        print("TEST: infoButtonTapped")
    }
    @objc func playButtonTapped(sender: UIButton!) {
        print("TEST: playButtonTapped")
    }
}
